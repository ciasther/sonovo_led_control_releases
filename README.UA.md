...
Оригінальний Arduino Leonardo використовує драйвер, вбудований у Windows. Клон із чипом CH340 не має драйвера у Windows 10 без Windows Update, тому пристрій відображається зі знаком оклику в Диспетчері пристроїв. Інтерактивний інсталятор один раз додає до сховища драйверів WHQL-драйвер, підписаний Microsoft, і один раз просить підтвердження адміністратора (UAC). Тихі встановлення й автоматичні оновлення пропускають цей крок, якщо не отримають `/CH340DRIVER=1`.
